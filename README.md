...
(hashmaps->sparse-table [{:hello "world", :blab "blip", :blop "12"} {:1 "asd", :2 "zc", :hello "nothing"}])
;; => (list (list "hello" "blab" "blop" "1" "2") (list "world" "blip" "12" nil nil) (list "nothing" nil nil "asd" "zc"))

(hashmaps->sparse-table [{:name "hello", :surname "world"} {:name "blab", :surname "blip", :whatever "blop"}] "n/a" [:whatever :name :surname])
;; => (list (list "whatever" "name" "surname") (list "n/a" "hello" "world") (list "blop" "blab" "blip"))
```
...
;; => (list [10 {:index 0, :last? false, :first? true}] [11 {:index 1, :last? false, :first? false}] [12 {:index 2, :last? false, :first? false}] [13 {:index 3, :last? true, :first? false}])
```
...
;; => (list (list 1 1 10) (list 2 2 11) (list 3 nil 12) (list 4 nil 13) (list 5 nil 14))
```
...
(filter-map-key (fn* [p1__5637#] (= p1__5637# :1)) {:1 1, :2 2, :3 3})
;; => {:1 1}
```
...
(filter-map-val (fn* [p1__5627#] (= p1__5627# 1)) {:1 1, :2 2, :3 3})
;; => {:1 1}
```
...
(nested-group-by [first second] [["A" 2011 "Dan"] ["A" 2011 "Jon"] ["A" 2010 "Tim"] ["B" 2009 "Tom"]])
...
(invert-map {1 ["hello" "world"], 2 ["not" "important"], 3 ["very" "important" "thing"]})
...
(paginate 1 3)
;; => (list {:page-num 1, :name "1", :cur? true, :first? true, :last? false} {:page-num 2, :name "2", :cur? false, :first? false, :last? false} {:page-num 3, :name "3", :cur? false, :first? false, :last? true})
...
;; => (list "left" "justify" "right" "left" "justify" "right" "left" "justify" "right")
```
...
;; => {:inverse? true, :field :age}

(parse-sorting-field "age")
;; => {:inverse? false, :field :age}

(parse-sorting-field "blab")
;; => {:inverse? false, :field :blab}
```
